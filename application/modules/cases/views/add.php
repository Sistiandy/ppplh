...
if (isset($violation)) {
    ...
    $TitleValue = $violation['violation_title'];
} else {
    $TitleValue = set_value('violation_title');
}
?>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Nama pelanggaran <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
                            <input name="violation_title" type="text" class="form-control" value="<?php echo $TitleValue ?>" placeholder="Nama pelanggaran">
                        </div>
            ...
            <div class="col-md-3">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <a href="<?php echo site_url('admin/violations'); ?>" class="btn btn-flat btn-block btn-info"><span class="fa fa-arrow-circle-left"></span> Batal</a>
                        <?php if (isset($violation)) { ?>
