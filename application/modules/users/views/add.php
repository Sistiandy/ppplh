                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="user_full_name" type="text" class="form-control" value="<?php echo $FullNameValue ?>" placeholder="Nama lengkap">
                        </div>

                        <div class="form-group">
                            <label>Tempat lahir <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
                            <input name="user_pob" type="text" class="form-control" value="<?php echo $PobValue ?>" placeholder="Tempat lahir">
                        </div>

                        <div class="form-group">
                            <label>Tanggal lahir <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
                            <input name="user_dob" type="text" class="form-control datepicker" value="<?php echo $DobValue ?>" placeholder="Tanggal lahir">
                        </div>

                        <div class="form-group">
                            <label>Email <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
                            <input name="user_email" type="email" class="form-control" value="<?php echo $EmailValue ?>" placeholder="Email">
                        </div>      

                        <div class="form-group">
                            <label>Username <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
                            <input name="user_name" type="text" class="form-control" <?php echo (isset($user)) ? 'disabled' : ''; ?> value="<?php echo $NameValue ?>" placeholder="Username">
                        </div>   
