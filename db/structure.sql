...
CREATE  TABLE IF NOT EXISTS `cases` (
  ...
  `case_evaluation3_note` TEXT NULL ,
  `case_evaluation3_status` ENUM('Taat', 'Belum Taat') NULL ,
  `case_evaluation4_note` TEXT NULL ,
  `case_evaluation4_status` ENUM('Taat', 'Belum Taat') NULL ,
  `case_evaluation5_note` TEXT NULL ,
...
CREATE  TABLE IF NOT EXISTS `cases_has_violations` (
  ...
  `verification_sanksi3` TINYINT(1) NULL COMMENT '1=Sudah, 0=Belum' ,
  `verification_sanksi4` TINYINT(1) NULL COMMENT '1=Sudah, 0=Belum' ,
  `verification_sanksi5` TINYINT(1) NULL COMMENT '1=Sudah, 0=Belum' ,
